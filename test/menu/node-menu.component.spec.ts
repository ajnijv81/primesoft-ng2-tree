...
describe('NodeMenuComponent', () => {
  ...
  xit('should have basic menu items', () => {
  ...
  xit('should render basic menu items', () => {
  ...
  xit('should not emit an action on right mouse button click', () => {
    fixture.detectChanges();
  ...
  xit('should emit an action on left mouse button click', () => {
    fixture.detectChanges();
